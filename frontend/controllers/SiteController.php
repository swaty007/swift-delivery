...
class SiteController extends Base21oldController
{
    ...
    {
        $allowedPages = [
            'index', 'logout', 'order', 'order-status', 'order-rating', 'cancel-order', 'error', 'show-info-page', 'has21', 'has21-fail'
        ];
    ...
    public function actionHas21($l = null)
    {
        if ($l) {
