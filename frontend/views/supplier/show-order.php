        ...
        <div class="modal__wrapper">
            <div class="modal__container container">
                ...
                <div class="modal__header">
                    ...
                    <br>
                    <a href="tel:<?=preg_replace( '/[^0-9]/', '', \common\models\User::find()->where(['id' => $order->customer->supplier_id])->one()->phone_number );?>">
                        <?= \common\models\User::find()->where(['id' => $order->customer->supplier_id])->one()->phone_number ;?>
                    </a>
                </div>
            </div>
        </div>
