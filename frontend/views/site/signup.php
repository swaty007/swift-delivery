...
<!--            <div class="col-lg-5">-->
                <div class="access__content">
                    ...
                    <?= $form->field($model, 'phone_number',['options' => ['class' => 'form-group']])->label(false)->widget(\yii\widgets\MaskedInput::className(), ['mask' => '+1 (999) 999-99-99'])->textInput(['placeholder' => '+1 (___) ___-__-__','class'=>'form-control no-border--top'])->label(false); ?>
