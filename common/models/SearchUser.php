...
class SearchUser extends User
{
    ...
    public function rules()
    {
        return [
            ...
            [['username', 'auth_key', 'password_hash', 'password_reset_token', 'email', 'phone_number', 'profile_image', 'verification_token'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $dataProvider = new ActiveDataProvider([
            'query' => $query,
            'sort' => ['attributes' => ['id','username','phone_number','role','created_at','status']],
        ]);
